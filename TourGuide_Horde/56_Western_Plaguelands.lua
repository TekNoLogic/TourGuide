...
return [[
F Orgrimmar
A A Call to Arms: The Plaguelands |N|Get from Warcaller Gorlach (can also get in Undercity if you can't find him)| |QID|???|
...
R The Bulwark
T A Call To Arms: The Plaguelands! |QID|???|
...
A Better Late Than Never (Part 1)|N|Lady in the house at Felstone Field (38,55)| |QID|???|
T Better Late Than Never (Part 1)|N|Barn next door| |QID|???|
A Better Late Than Never (Part 2) |N|Click chest again| |QID|???|

C Scarlet Diversions |N|Burn the tent, plant the banner (40,51)| |QID|5096|
...
C Target: Felstone Field |N|To the east at Felstone Field (37,56).  Kill Cauldron Lord Bilemaw for the key, then talk to the cauldren.| |QID|5229|
T Target: Felstone Field |N|Talk to the cauldren| |QID|5229|
A Return to the Bulwark (Part 1) |QID|???|
...
T Return to the Bulwark (Part 1) |QID|???|
A Target: Dalson's Tears |QID|5231|

C Target: Dalson's Tears |N|To the east at Dalson's Tears (46,52).  Kill Cauldron Lord Malvinious for the key, then talk to the cauldren.| |QID|5231|
T Target: Dalson's Tears |N|Talk to the cauldren| |QID|5231|
A Return to the Bulwark (Part 2) |QID|???|
...
T Return to the Bulwark (Part 2) |QID|???|
A Target: Writhing Haunt |QID|5233|

C Target: Writhing Haunt |N|To the east at Writhing Haunt (53,65).  Kill Cauldron Lord Razarch for the key, then talk to the cauldren.| |QID|5233|
T Target: Writhing Haunt |N|Talk to the cauldren| |QID|5233|
A Return to the Bulwark (Part 3) |QID|???|

A The Wildlife Suffers Too (Part 1) |N|In the house by the field (54,65)| |QID|???|
...
T Return to the Bulwark (Part 3) |QID|???|
...
A Return to the Bulwark (Part 4) |QID|???|
