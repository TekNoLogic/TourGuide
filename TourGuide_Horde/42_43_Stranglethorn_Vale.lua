...
C Up to Snuff
C Keep An Eye Out
C Mok'thardin's Enchantment (Part 4) |N|At (25,63)|
C Akiris by the Bundle |N|At (25,63)|
C Raptor Mastery (Part 4) |N|Tethis kill at (28,44)|
C Zanzil's Secret |N|At (34,52)|
C Voodoo Dues |N|At (39,58)|
C Venture Company Mining |N|At (41,44)|

T Raptor Mastery (Part 4)
A Big Game Hunter

T Mok'thardin's Enchantment (Part 4) |N|Back at Grom'gol Base Camp|
