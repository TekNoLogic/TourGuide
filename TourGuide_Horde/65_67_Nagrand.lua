...
A The Howling Wind |QID|9861| |N|Kill air elementals till the items drops to start this quest| |U|24504|
...
A Wanted: Giselda the Crone |QID|9935|
A Wanted: Zorbo the Advisor |QID|9939|
A The Consortium Needs You! |QID|9913| |N|From the ethereal just outside Garadar (51.94, 34.79)|

T The Howling Wind |QID|9861|
...
T The Impotent Leader |QID|9888|
...
C Message in a Battle |QID|9906|
C Standards and Practices |QID|9910|

T Standards and Practices |QID|9910|
A Bleeding Hollow Supply Crates |QID|9916|
T Message in a Battle |QID|9906|
...
T An Audacious Advance |QID|9907|
A Diplomatic Measures |QID|10107|

C Diplomatic Measures |QID|10107|
T Diplomatic Measures |QID|10107|
A Armaments for Deception |QID|9928|
A Ruthless Cunning |QID|9927|

C Wanted: Giselda the Crone |QID|9935| |N|Giselda is in the main building (72.06, 81.46).  Make sure to plant banners on the mobs you kill.| |U|25552|
C Armaments for Deception |QID|9928| |N|Many boxes spawn on the east side of the main building, and respawn faster than the mobs there do.| |U|25552|
C Ruthless Cunning |QID|9927| |U|25552|
...
C Body of Evidence |QID|9932| |U|25658| |N|Use the blanket on the pyre in the Laughing Skull Courtyard (46.56, 24.55).  Make sure you hang around until the orges finish, and don't forget to stick banners in the mobs you kill.|
C Wanted: Zorbo the Advisor |QID|9939| |N|In a cave up the hill from the pyre (46.53, 17.93).  Remember to keep planting banners.| |U|25555|
...
T Returning the Favor |QID|9931|
