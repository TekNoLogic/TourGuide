...
return [[
A The Hunt Begins |QID|747|
C The Hunt Begins |QID|747|
T The Hunt Begins |QID|747|

A Etched Note |C|Hunter| |QID|3092|
A Simple Note |C|Warrior| |QID|3091|
A Rune-Inscribed Note |C|Shaman| |QID|3093|
...
C The Battleboars |QID|780|
C Rite of Strength |QID|757|
C Break Sharptusk! |QID|3376|
N Find the Dirt-stained Map |L|4851| |N|In the cave to the south of Sharptusk's hut (63.21, 82.75)|
A Attack on Camp Narache |U|4851| |QID|781|
...
C Sharing the Land |N|To the south by the cliffs| |QID|745|
...
C Dwarven Digging |N|Kill the dorfs for their tools, then find the forge in the camp and break them.| |U|4702| |QID|746|
C Swoop Hunting |QID|761|
C Mazzranache |QID|766|

T Thunderhorn Totem |N|Back at Bloodhoof Village| |QID|756|
T Dwarven Digging |QID|746|
T Swoop Hunting |QID|761|
T Mazzranache |QID|766|

A Thunderhorn Cleansing |QID|758|
C Thunderhorn Cleansing |U|5415| |QID|758|
...
C Dangers of the Windfury |N|To the east, south of the road (64,70).| |QID|743|
C Wildmane Totem |QID|759|

T Wildmane Totem |N|Back at Bloodhoof Village| |QID|759|
...
C Body and Heart |C|Druid| |N|On the edge of the Barrens, just as you leave Mulgore, south of the road behind the hut (42.00, 60.89).  Use the dust, kill the boomkin, talk to him.| |U|15710| |QID|6002|
T Body and Heart |C|Druid| |N|Run east to Camp Taurajo and fly to Bluff| |QID|6002|

C Wildmane Cleansing |N|North of Bluff| |U|5416| |QID|760|
C The Hunter's Way |QID|861|
A A Sacred Burial |N|East at Red Rocks Amphitheatre (59.83, 25.60)| |QID|833|
T Rite of Wisdom |N|To the north, in the middle of the graveyard| |QID|773|
A Journey into Thunder Bluff |QID|775|
C A Sacred Burial |QID|833|
T A Sacred Burial |QID|833|
C Preparation for Ceremony |N|Harpies to the north.  You can also find a bunch west of Bluff.| |QID|744|

T Preparation for Ceremony |N|Back on Bluff| |QID|744|
...
H Bloodhoof Village
A The Demon Scarred Cloak |O| |U|4854| |QID|770|
T The Demon Scarred Cloak |O| |QID|770|
T Dangers of the Windfury |QID|743|
T Wildmane Cleansing |QID|760|

C Supervisor Fizsprocket |N|In the mine to the east of the Ravaged Caravan (61,47)| |QID|765|
