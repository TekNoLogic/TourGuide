...
N Un'goro grind! While you're questing, kill oozes when you see them and loot Bloodpetal Pods
C Super Sticky
...
N And a batch of ooze... make sure you have 30 ooze samples
...
T The Scent of Lar'korwi  |N|at (71,75)|
A The Bait for Lar'korwi

C Alien Ecology |N|(50,80)|
...
C Volcanic Activity
C Lost! |N|Jump down from the hotspot plateau to the second cave. Make sure other quests are all done.|
T Lost!
...
C The Bait for Lar'korwi |N|(80,50)|
T The Bait for Lar'korwi |N|(71,75)|
T The Mighty U'cha
...
R Marshal's Refuge |N|Kill more oozes along the way if you have less then 30 ooze samples|
