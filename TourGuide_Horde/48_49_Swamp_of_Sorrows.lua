...
T Cortello's Riddle (Part 1) |N|Under the bridge (22,48)| |QID|???|
A Cortello's Riddle (Part 2) |QID|???|
...
T Cortello's Riddle (Part 2) |N|West to Bloodfen Cave (31,67)| |Z|Dustwallow Marsh| |QID|???|
A Cortello's Riddle (Part 3) |QID|???|
