...
F Hammerfall
h Hammerfall
T Trollbane |N|Skip the follow-up.. Maybe? non elite now?| |QID|638|
A Foul Magics |QID|673|
A Guile of the Raptor (Part 1) |QID|???|
...
C Guile of the Raptor (Part 1) |QID|???|
...
H Hammerfall
T Call to Arms (Part 2) |QID|???|
T Foul Magics |QID|673|
T The Hammer May Fall |QID|676|
T Guile of the Raptor (Part 1) |QID|???|
A Guile of the Raptor (Part 2) |QID|???|
T Guile of the Raptor (Part 2) |QID|???|
A Guile of the Raptor (Part 3) |QID|???|
T Guile of the Raptor (Part 3) |QID|???|
]]
end)
