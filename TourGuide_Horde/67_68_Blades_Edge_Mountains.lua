...
H Thunderlord Stronghold
T Felling an Ancient Tree
T The Bladespire Threat
T The Encroaching Wilderness
T Thunderlord Clan Artifacts
A The Bloodmaul Ogres
A Dust from the Drakes
A Vision Guide
C Vision Guide
T Vision Guide
A The Thunderspike
...
A The Spirits Have Voices
T The Spirits Have Voices
A Whispers on the Wind
...
A Wyrmskull Watcher
C Creating the Pendant |N|Kill arakkoa for six claws, use them at the green circle|
T Creating the Pendant
A Whispers of the Raven God
T Wyrmskull Watcher |N|Turns in at (50,36)|
A Longtail is the Lynchpin
C Longtail is the Lynchpin |N|She's wandering in the tunnel, then run back and|
T Longtail is the Lynchpin
A Meeting at the Blackwing Coven
C Whispers of the Raven God |N|First (39,17), Second (42,21), Third (40,18), Forth (40,23) should find item which starts|
A The Truth Unorbed
...
C Culling the Wild |N|Done around (72,28) should find item which starts|
A Damaged Mask
C Little Embers
C From the Ashes
...
T Trial and Error
A Ruuan Weald
A Since Time Forgotten...
A The Totems of My Enemy
...
T On Spirit's Wings
A Baron Sablemane
T Baron Sablemane |N|Turns in at (53,41)|
...
F Evergrove
C Felsworn Gas Mask |N| Communicator is at (73,39) need to equip mask to activate it|
T Felsworn Gas Mask
A Deceive thy Enemy
C Deceive thy Enemy
...
T Exorcising the Trees |N|Turns in at (37,23)|
