...
T Mok'thardin's Enchantment (Part 2) |N|At Grom'gol| |QID|572|
A Mok'thardin's Enchantment (Part 3) |QID|571|

C Panther Mastery (Part 3) |N|Kill Bhag'thera at either (48,20),(49,23),(47,26)| |QID|193|

T Panther Mastery (Part 3) |QID|193|
T Raptor Mastery (Part 3) |QID|196|
A Raptor Mastery (Part 4) |N|Tethis, don't do it yet| |QID|197|

H Booty Bay |SZ|The Salty Sailor Tavern|
T The Bloodsail Buccaneers (Part 1) |N|NW of BB at (27,69) click on the note| |QID|595|
...
T The Bloodsail Buccaneers (Part 3) |N|At Fleet Master Seahorn| |QID|599|

F Grom'gol Base Camp
T Mok'thardin's Enchantment (Part 3) |QID|571|
A Mok'thardin's Enchantment (Part 4) |QID|573|
