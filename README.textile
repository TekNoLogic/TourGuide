...
TourGuide does not provide coords for every single objective.  If you are lost check with "LightHeaded":http://www.wowinterface.com/downloads/info7017-LightHeaded.html or "Wowhead":http://www.wowhead.com and "submit a bug":http://github.com/tekkub/TourGuide/blob/docs/submitting_bugs.markdown so notes can be added to the objective.
