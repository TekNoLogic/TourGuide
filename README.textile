...
TourGuide does not provide coords for every single objective.  If you are lost check with "LightHeaded":http://www.wowinterface.com/downloads/info7017-LightHeaded.html or "Wowhead":http://www.wowhead.com and "submit a bug":http://github.com/tekkub/TourGuide/blob/master/docs/submitting_bugs.markdown so notes can be added to the objective.
...
Please read "How to edit TourGuide guides":http://github.com/tekkub/TourGuide/blob/master/docs/writing_guides.markdown for help on the format and general guidelines.
...
See "this page":http://github.com/tekkub/TourGuide/blob/master/docs/submitting_bugs.markdown for details on how to fork my github repo to push your changes.
...
This addon is brought to you by "ZygorGuides.com":ZygorGuides.com.  No unauthorized distribution of this addon is permitted.
