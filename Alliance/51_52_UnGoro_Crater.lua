...
N Kill stuff... |N|Kill any bloodpetals, diametradons,  pterrordaxes and frenzied pterrordaxes you come across|

C The Northern Pylon |N|Along the north edge of the zone to the east (56,12).  Kill pterrordaxes here.|
...
C Beware of Pterrordax |N|You can find the Frenzied Pterrordaxes all over the west half of the zone|
C Roll the Bones
C Muigin and Larion

C Finding the Source |N|At the volcano in the center of the zone.  Right click on "Hot Spots" until you complete the quest.|
C Volcanic Activity |N|Kill elementals|
T Finding the Source
A The New Springs
