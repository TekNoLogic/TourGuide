...
T Assisting Arch Druid Staghelm |N|In a tower in the Cenarion Enclave (34.8, 8.7)|
A Un'Goro Soil
h Darnassus |N|The inn is in the Craftsman's Terrace (67.2,15.7)

F Theramore
C Ledger from Tanaris |N|Find the package in the wreckage of a zepplin (54.1,55.9)|
T Cortello's Riddle (Part 2) |N|Find a Musty Scroll in a cave to the southwest (31.1,66.1)|
