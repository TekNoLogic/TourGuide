...
T The Missing Diplomat (Part 13) |T| |QID|???|
A The Missing Diplomat (Part 14) |T| |QID|???|
A A Disturbing Development |T| |QID|11136|

T The Missing Diplomat (Part 14) |N|Inside the tower along road northwest of Theramore (59.7, 41.1).  If he is not there just wait, he'll be back.| |QID|???|
A The Missing Diplomat (Part 15) |QID|???|
...
T The Missing Diplomat (Part 15) |QID|???|
A The Missing Diplomat (Part 16) |QID|???|
C The Missing Diplomat (Part 16) |QID|???|
T The Missing Diplomat (Part 16) |QID|???|
...
A Lieutenant Paval Reethe (Part 1) |QID|???|
...
T Lieutenant Paval Reethe (Part 1) |T| |QID|???|
A Lieutenant Paval Reethe (Part 2) |T| |QID|???|
T The Black Shield (Part 1) |T| |QID|???|
A The Black Shield (Part 2) |T| |QID|???|
T Lieutenant Paval Reethe (Part 2) |T| |QID|???|
A Daelin's Men |T| |QID|1285|
T Daelin's Men |T| |QID|1285|
A The Deserters (Part 1) |T| |QID|???|
...
T The Black Shield (Part 2) |T| |N|At the smithy's| |QID|???|
A The Black Shield (Part 3) |T| |QID|???|
T The Black Shield (Part 3) |T| |N|Back in the keep| |QID|???|
...
T The Deserters (Part 1) |N|Beat down Balos Jacken at Lost Point Tower to the south (35,53) until he'll talk to you| |QID|???|
A The Deserters (Part 2) |QID|???|

H Theramore Isle
T Jaina Must Know |N|Up in the tower| |T| |QID|11141|
A Survey Alcaz Island |T| |QID|11142|
T The Deserters (Part 2) |N|In the keep| |T| |QID|???|
