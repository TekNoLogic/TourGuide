...
A Tramping Paws
C Tramping Paws |N|Camps far south near Dun Algaz (56,74) (61,75)|
T Tramping Paws
A Fire Taboo
C Fire Taboo |N|Camps northwest of the fork in the road|
...
T The Search Continues |N|Sealed Barrel at the next murloc camp to the north|
A Search More Hovels
T Search More Hovels |N|Half-buried Barrel at the next murloc camp to the north|
A Return the Statuette

C The Cursed Crew |N|On the southern shipwreck (13,30).  Snellig is in the bottom of the ship, you can enter thru a hole on the side nearest the shore.|
C Apprentice's Duties |N|North of the murloc camps and east of Menethil Harbor (19,59) (25,22).  Kill giant crocs near the shore, normal ones don't drop the item.|
C Blisters on The Land |N|Just run around in the water, they stealth.| |NODEBUG|
C Digging Through the Ooze |N|Around Ironbeard's Tomb (44,25)|
