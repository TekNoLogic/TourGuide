...
return [[
F Menethil Harbor
T The Missing Diplomat (Part 10) |N|In the inn| |T| |QID|???|
A The Missing Diplomat (Part 11) |T| |QID|???|
C The Missing Diplomat (Part 11) |T| |QID|???|
T The Missing Diplomat (Part 11) |T| |QID|???|
A The Missing Diplomat (Part 12) |N|At the guy you just fought| |T| |QID|???|
T The Missing Diplomat (Part 12) |T| |QID|???|
...
C The Tower of Althalaxx (Part 6) |N|Follow the road northwest from Fallen Sky Lake past Raynewood Retreat (64.80, 43.80), then double back along the ridge east of the road to the crystal in Night Run (67,54).| |QID|???|
C Satyr Slaying! |QID|1032|
C Raene's Cleansing (Part 4) |N|To the northeast, just before entering felwood.  Kill treants for the key and open the box (54,35)| |QID|???|
...
T The Tower of Althalaxx (Part 6) |N|Back at Maestra's Post, skip the follow-up.| |QID|???|
T Raene's Cleansing (Part 4) |N|Back at the Moonwell (53,46).  Skip the follow-up.| |QID|???|
