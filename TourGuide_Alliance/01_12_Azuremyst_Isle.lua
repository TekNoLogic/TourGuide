...
A Call of Earth (Part 1) |C|Shaman| |QID|???|
T Spare Parts |QID|9305|
T Inoculation |QID|9303|
A The Missing Scout |QID|9309|
T Call of Earth (Part 1) |N|Northwest of Crash Site (71,40)| |C|Shaman| |QID|???|
A Call of Earth (Part 2) |C|Shaman| |QID|???|
C Call of Earth (Part 2) |C|Shaman| |QID|???|
T Call of Earth (Part 2) |C|Shaman| |QID|???|
A Call of Earth (Part 3) |C|Shaman| |QID|???|
T Call of Earth (Part 3) |N|At the Crash Site| |C|Shaman| |QID|???|
...
A The Great Moongraze Hunt (Part 1) |QID|???|
...
C The Great Moongraze Hunt (Part 1) |QID|???|
...
T The Great Moongraze Hunt (Part 1) |QID|???|
A The Great Moongraze Hunt (Part 2) |QID|???|
...
C The Great Moongraze Hunt (Part 2) |N|North of Azure Watch| |QID|???|
...
T The Great Moongraze Hunt (Part 2) |QID|???|
...
A Call of Fire (Part 1) |C|Shaman| |QID|???|
...
T Call of Fire (Part 1) |N|Go further northeast| |C|Shaman| |QID|???|
A Call of Fire (Part 2) |C|Shaman| |QID|???|
...
T Call of Fire (Part 2) |C|Shaman| |QID|???|
A Call of Fure (Part 3) |C|Shaman| |QID|???|
...
C Call of Fire (Part 3) |N|Head down to Silvermyst Isle, find the Wickerman Effigy (11,82)| |C|Shaman| |QID|???|
U Orb of Returning |C|Shaman| |U|24335|
T Call of Fire (Part 3) |C|Shaman| |QID|???|
A Call of Fire (Part 4) |C|Shaman| |QID|???|
]]
end)
