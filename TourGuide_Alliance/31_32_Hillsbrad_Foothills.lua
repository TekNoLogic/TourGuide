...
A Encrypted Letter |N|Examine documents on the table in the camp to the east (58,67)| |Z|Alterac Mountains|
A Foreboding Plans |N|Examine documents on the table in the camp|
C Syndicate Assassins
C Costly Menace |N|Go west (46,81)| |Z|Alterac Mountains|

N Kill yetis |N|In the yeti cave (48,33).  Need [Yeti Fur] x10 for "Bartolo's Yeti Fur Cloak".| |L|3720 10|
...
B Swiftness Potion |L|2459| |N|Buy from auction or an alchemist. You'll need it to jump to MacKreel's Moonshine| |C|Paladin|
B Swiftness Potion |L|2459| |N|Buy from auction or an alchemist. You'll need it to jump to MacKreel's Moonshine| |C|Priest|
B Swiftness Potion |L|2459| |N|Buy from auction or an alchemist. You'll need it to jump to MacKreel's Moonshine| |C|Warlock|
B Swiftness Potion |L|2459| |N|Buy from auction or an alchemist. You'll need it to jump to MacKreel's Moonshine| |C|Warrior|
