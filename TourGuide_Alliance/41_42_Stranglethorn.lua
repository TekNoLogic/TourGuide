...
h Booty bay
A Akiris by the Bundle (Part 1) |N|From Privateer Bloads next to the Bank.| |QID|???|
...
A The Bloodsail Buccaneers (Part 1) |N|From First Mate Crazz just past the "Old Port Authority" building (First big building when getting off the Boat).| |QID|???|

T The Bloodsail Buccaneers (Part 1) |N|On top of one of the barrels| |QID|???|
A The Bloodsail Buccaneers (Part 2) |QID|???|
C Akiris by the Bundle (Part 1) |N|Northwest across the bridge (24,65)| |QID|???|
...
T The Bloodsail Buccaneers (Part 2) |N|At First Mate Crazz a bit further towards the Inn.| |QID|???|
A The Bloodsail Buccaneers (Part 3) |QID|???|
T Stranglethorn Fever |QID|348|
T Akiris by the Bundle (Part 1) |N|At Privateer Bloads next to the bank.| |QID|???|
A Akiris by the Bundle (Part 2) |QID|???|
A Up to Snuff |N|From Deeg on the 2nd floor of the Inn.| |QID|587|
T The Bloodsail Buccaneers (Part 3) |N|At Fleet Master Seahorn on the 2nd Floor of the Inn.| |QID|???|
A The Bloodsail Buccaneers (Part 4) |QID|???|
...
C The Bloodsail Buccaneers (Part 4) |N|From the Booty Bay exit head east to the coast, then south.  Items can be found at the two camps (30,81) (27,83), and in a rowboat (28,83).| |QID|???|
...
T The Bloodsail Buccaneers (Part 4) |N|At Fleet Master Seahorn, 2nd Floor of the Inn.| |QID|???|
