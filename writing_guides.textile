...
bc. TourGuide:RegisterGuide("Tanaris (47-48)", "Hinterlands (48)", "Alliance", function()
return [[
F Gadgetzan
...
bc. A Quest Name |N|A note with coords (12,34)| |QID|1234|
...
bc. A Panther Mastery (Part 1) |QID|190|
...
h3. Use decent English

_*This is the most important rule of all.*_  I'm not asking for Ph.D. thesis quality here.  Write your notes out in good, plain, simple English.   Like on this page, use correct punctuation and capitalization.   Break apart run-on sentences.   Write like you're writing a newspaper article, not a text message from a cell phone.   If English isn't your native language that's totally acceptable, if basic typing is beyond you however...

h3. Guide the player, don't hold their hand
...
h3. Don't give the user the "runaround"
...
h3. Give exact coords as often as possible
...
h3. Don't go overboard with coords
...
h3. Don't rely completely on coords
...
bc. |N|Kill Gor'marok at (41.11, 57.31)|
|N|At (47,66)|

bc. |N|Kill Gor'marok in a small cave at the Dunemaul Compound (41.11, 57.31)|
|N|Head southeast to the Eastmoon Ruins (47,66)|

h3. Don't overuse note objectives
...
h3. Streamline multiple Complete objectives
